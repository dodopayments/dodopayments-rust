...
- <code title="post /subscriptions/{subscription_id}/change-plan">client.subscriptions().change_plan().subscription_id(subscription_id: impl Into&lt;String&gt;).body(body: SubscriptionsChangePlanParams) -&gt; Result&lt;SubscriptionChangePlanResponse&gt;</code>
